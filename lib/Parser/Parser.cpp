...
bool Parser::parseDeclaration(DeclList& Decls){
    auto _errorhandler = [this]{
        return skipUntil(tok::kw_BEGIN, tok::kw_CONST,tok::kw_END,tok::kw_PROCEDURE);
    };
...
bool Parser::parseProcedureDeclaration(DeclList& ParentDecls){
    ...
    ProcedureDeclaration* D = Actions.actOnProcedureDeclaration(Tok.getLocation(),
             Tok.getIdentifier());
...
bool Parser::parseStatement(StmtList& Stmts){
    auto _errorhandler = [this]{return skipUntil(tok::semi, tok::kw_ELSE,
        tok::kw_END);};
...
bool Parser::parseWhileStatement(StmtList& Stmts){
    auto _errorhandler = [this]{return skipUntil(tok::semi, tok::kw_ELSE, tok::kw_END);};
...
bool Parser::parseExpression(Expr *&E){
    auto _errorhandler = [this]{
        ...
        tok::kw_ELSE, tok::kw_END,tok::kw_END);
...
bool Parser::parseSimpleExpression(Expr *&E){
    auto _errorhandler = [this]{return skipUntil(tok::hash,
    tok::r_paren,tok::comma,tok::semi,tok::less, tok::lessequal,
