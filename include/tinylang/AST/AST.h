...
namespace tinylang{
    ...
    public:
        ...
        ProcedureDeclaration(Decl* EnclosingDecl, SMLoc Loc, StringRef Name,
        FormalParamList& Params, TypeDeclaration* RetType, DeclList& Decls,
        StmtList& Stmts):Decl(DK_Proc,EnclosingDecl, Loc, Name),
    ...
    public:
        ...
        TypeDeclaration* Ty, bool IsConst):Expr(EK_Infix, Ty, IsConst),
    ...
    public:
        PrefixExpression(Expr *E, OperatorInfo Op,TypeDeclaration *Ty,
             bool IsConst): Expr(EK_Prefix, Ty, IsConst), E(E), Op(Op) {}
