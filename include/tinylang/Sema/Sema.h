...
class Sema{
    ...
    void checkFormalAndActualParameters(SMLoc Loc, const FormalParamList& Formal,
...
public:
        Sema(DiagnosticsEngine& Diags):CurrentScope{nullptr}, CurrentDecl{nullptr},
            Diags{Diags}{
        ...
        SMLoc Loc, StringRef Name, DeclList& Decls, StmtList& Stmts);
        ...
        void actOnProcedureHeading(ProcedureDeclaration* ProcDecl, FormalParamList& Params,
            Decl* RetType);
        ...
        void actOnIfStatement(StmtList& Stmts, SMLoc Loc, Expr* Cond, StmtList &IfStmts,
            StmtList& ElseStmts);
